...
// コンパイル: g++ mp4Read.cpp -o mp4Read `pkg-config --libs opencv`
...
{   
    ...
    std::string filepath = "rainbow.mp4";
	...
	double fps;
    fourcc = VideoWriter::fourcc('m', 'p', '4', 'v'); // ビデオフォーマットの指定( ISO MPEG-4 / .mp4)
